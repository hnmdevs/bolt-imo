  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-vime-elements-item-contentDefault hover:text-vime-elements-item-contentActive hover:bg-vime-elements-item-backgroundActive':
          !selected,
        'bg-vime-elements-item-backgroundAccent text-vime-elements-item-contentAccent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-vime-elements-item-backgroundActive text-vime-elements-item-contentDefault': !selected,
        'bg-vime-elements-item-backgroundAccent text-vime-elements-item-contentAccent': selected,
      })}
      depth={depth}
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-vime-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
